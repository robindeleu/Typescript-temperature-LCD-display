/**
 * The Numbertosegmentframework class make from all the segments numbers.
 * 
 ...
 *
 * const cijfers = new Numbertosegmentframework()
 * cijfers.segmentzero()
 * cijfers.segmentone()
 * cijfers.segmenttwo()
...
export class Numbertosegmentframework{
    /**
