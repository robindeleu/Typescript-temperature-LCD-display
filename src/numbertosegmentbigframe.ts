/**
 * The Numbertosegmentbigframe class make from all the segments numbers.
 * 
 ...
 *
 * const cijfers = new Numbertosegmentbigframe()
 * cijfers.segmentzero()
 * cijfers.segmentone()
 * cijfers.segmenttwo()
...
export class Numbertosegmentbigframe{
    /**
    ...
    segmentzero(){
        ...
        console.log('\n',"|",seg.segmenthorizontaalbig(),"|",'\n',"|",seg.segmentverticaalcombobig(),"|",'\n',"|",seg.segmentverticaalcombobig(),"|",'\n',"|",seg.segmentverticaalcombobig(),"|",'\n',"|",seg.segmenthorizontaalbig(),"|")
        return " "
    }
    /**
    ...
    */
    ...
    segmentnan(){
        const seg = new Segments()
        console.log('\n',"|",seg.segmentemptyhorizontaalbig(),"|",'\n',"|",seg.segmentcommabig(),"|")
        return " "
    }
