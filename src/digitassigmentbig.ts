/**
 * The Digitassigmentbig class make from a number that we can read a digit number but in big numbers
 * 
 ...
 *
 * const tem = new Digitassigmentbig()
...
export class Digitassigmentbig{
    /**
  * In this methode he check wich number you have and couple it to the big digits
  *  
  * @param waarde This is the number you wants to make a big digit of
  * 
  * @return the same number but in a big digit
  */
    decide(waarde: number){
        const seg = new Numbertosegmentbig()
        if(waarde == 0){
