/**
 * The Digitassigment class make from a number that we can read a big digit number with a frame around it
 * 
 ...
 *
 * const tem = new Digitassigmentbigframe()
...
export class Digitassigmentbigframe{
    /**
  * In this methode he check wich number you have and couple it to the big digits with a frame around it
  *  
  ...
  */
    decide(waarde: number){
        const seg = new Numbertosegmentbigframe()
        if(waarde == 0){
