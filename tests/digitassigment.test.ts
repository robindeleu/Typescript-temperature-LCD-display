import {Digitassigment} from '../src/digitassigment'
import {Numbertosegment} from '../src/numbertosegment'
const digit = new Digitassigment()
const number = new Numbertosegment()
