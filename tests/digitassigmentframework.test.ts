import {Digitassigmentframework} from '../src/digitassigmentframework'
import {Numbertosegmentframework} from '../src/Numbertosegmentframework'
const digit = new Digitassigmentframework()
const number = new Numbertosegmentframework()
