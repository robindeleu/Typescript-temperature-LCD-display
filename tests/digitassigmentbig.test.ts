import {Digitassigmentbig} from '../src/digitassigmentbig'
import {Numbertosegmentbig} from '../src/numbertosegmentbig'
const digit = new Digitassigmentbig()
const number = new Numbertosegmentbig()
